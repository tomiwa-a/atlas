...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'My Tutorials', href: '/dashboard/my-tutorials' },
    {
      name: 'Learning Paths',
      dropdown: true,
      items: [
        { name: 'Active Courses', href: '/dashboard/learning-paths' },
        { name: 'Browse Subjects', href: '/dashboard/learning-paths/browse' },
        { name: 'Custom Paths', href: '/dashboard/learning-paths/custom' }
      ]
    },
